...
describe Book do
  ...
  describe 'initialization' do
    it 'creates a new Book instance' do
      book = Book.new(book_id, publish_date, publisher, cover_state, archived: archived)
  ...
  describe '#can_be_archived?' do
    it 'returns true if the cover state is bad' do
      book = Book.new(book_id, publish_date, publisher, 'bad', archived: archived)
      expect(book.can_be_archived?).to be true
    end

    it 'returns false if the cover state is not bad' do
      book = Book.new(book_id, publish_date, publisher, 'good', archived: archived)
